...
#ifndef TNT_UTILS_ANIMATIONCOMPONENTMANAGER_H
#define TNT_UTILS_ANIMATIONCOMPONENTMANAGER_H
 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
    class UTILS_PUBLIC AnimatinoComponentManager : private SingleInstanceComponentManager<Animation>
    {
    public:
        using Instance = EntityInstance<AnimatinoComponentManager>;
     ...
     */
        explicit AnimatinoComponentManager(EntityManager& em);
        ~AnimatinoComponentManager();
     ...
     */
        ...
        {
            SingleInstanceComponentManager<Animation>::gc(em, [this](Entity e) {
                removeComponent(e);
            });
        }
    };
