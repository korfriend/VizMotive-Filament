...
namespace filament::assimp {
    ...
    Texture* VzMeshAssimp::createOneByOneTexture(uint32_t pixel) {
    ...
    bool VzMeshAssimp::setFromFile(Asset& asset, std::map<std::string, MaterialInstance*>& outMaterials) {
        Importer importer;
    ...
    void VzMeshAssimp::processNode(Asset& asset,
        std::map<std::string,
