...
#define INTERNAL_AIDEFAULTMAT_DATA (FILAMENTAPP_PACKAGE + FILAMENTAPP_AIDEFAULTMAT_OFFSET)
#define INTERNAL_AIDEFAULTTRANS_DATA (FILAMENTAPP_PACKAGE + FILAMENTAPP_AIDEFAULTTRANS_OFFSET)
#define INTERNAL_DEPTHVISUALIZER_DATA (FILAMENTAPP_PACKAGE + FILAMENTAPP_DEPTHVISUALIZER_OFFSET)
#define INTERNAL_TRANSPARENTCOLOR_DATA (FILAMENTAPP_PACKAGE + FILAMENTAPP_TRANSPARENTCOLOR_OFFSET)
